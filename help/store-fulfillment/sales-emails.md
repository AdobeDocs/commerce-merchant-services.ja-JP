...
<tr>
<td><strong>代替ピックアップ連絡先のピックアップメールテンプレートのオーダー準備完了</strong></td>
...
<tbody><tr>
<td><strong>有効</strong></td>
<td>この電子メールは顧客に送信され、マーチャントストアで注文がキャンセルされたことが通知されます。 に設定 <code>No</code> 電子メール通知を無効にする。 電子メールテンプレートが無効になっている場合は、注文がキャンセルされることを防ぐことはできません。</td>
<td>ストア表示</td>
<td>いいえ</td>
</tr>
<tr>
...
<tbody><tr>
<td><strong>有効</strong></td>
<td>この電子メールは顧客に送信され、商店店で注文の一部がキャンセルされたことが通知されます。 に設定 <code>No</code> 電子メール通知を無効にする。 E メールテンプレートが無効になっている場合は、注文が一部キャンセルされるのを防ぐことはできません。</td>
<td>ストア表示</td>
<td>いいえ</td>
</tr>
<tr>
