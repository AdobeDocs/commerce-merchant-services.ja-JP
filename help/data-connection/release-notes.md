...
![ 新規 ](../assets/new.svg) - Experience Platformへのストアフロントイベントの送信を [ オフ ](connect-data.md#data-collection) する機能が追加されました。
![ 修正 ](../assets/fix.svg) - コンテンツセキュリティポリシー設定を更新しました。
...
![ 新規 ](../assets/new.svg) - （Beta）Experience Platformに注文履歴 [ データおよびステータスを送信 ](connect-data.md#beta-send-historical-order-data) する機能が追加されました。
